...
using Sula.Shipment.Web.ViewModels.Manage;
using System;
using System.Linq;
using System.Text;
...
namespace Sula.Shipment.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> MyAccount(IndexViewModel model)
        {
            ...
            if (model.Name != name || model.Surname != surname || model.Address != address)
            {
                ...
                {
                    throw new ApplicationException($"Unexpected error occurred setting properties for user with ID '{user.Id}'.");
                }
            }
