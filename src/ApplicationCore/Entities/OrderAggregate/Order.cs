...
namespace Sula.Shipment.ApplicationCore.Entities.OrderAggregate
{
    public class Order : BaseEntity, IAggregateRoot
    {
        ...
        public Order(string buyerId, Address shipToAddress, List<OrderItem> items, string checkoutMethod, DateTime courierArrival, string rcptName, string rcptSurname, string rcptPhone)
        {
            ...
            CourierArrivalTime = courierArrival;
            RecipientName = rcptName;
            RecipientSurname = rcptSurname;
            RecipientPhoneNo = rcptPhone;
